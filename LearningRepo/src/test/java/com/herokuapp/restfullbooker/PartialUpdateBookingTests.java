...
public class PartialUpdateBookingTests extends BaseTest {
	...
	public void partialUpdateBookingTest() {
		...
		softAssert.assertEquals(actualLastName, "Wadake", "lastname in response is not expected");
		...
		softAssert.assertEquals(actualAdditionalneeds, "baby crib in room", "additionalneeds in response is not expected");
